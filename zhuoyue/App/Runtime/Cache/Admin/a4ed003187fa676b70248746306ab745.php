...
<div class="so_main">
    ...
    <div class="form2">
            <div id="tab_1">
                <input type="hidden" id="crowd_id" name="crowd_id" value="<?php echo ($crowd_detail['id']); ?>"/>
                <dl class="lineD">
                    <dt>众筹名称：</dt>
                    <dd>
                        <input type="text" style="width: 400px;" disabled value="<?php echo ($crowd_detail['crowd_name']); ?>"/>
                    </dd>
                </dl>
                <dl class="lineD">
                    <dt>众筹金额：</dt>
                    <dd>
                        <input type="text" style="width: 400px;" disabled value="<?php echo ($crowd_detail['has_crowd_money']); ?>元"/>
                ...
                <dl class="lineD">
                    <dt>投票金额：</dt>
                    <dd>
                        <input type="text" style="width: 400px;" disabled value="<?php echo ($crowd_detail['vote_money']); ?>元"/>
                ...
                <dl class="lineD">
                    <dt>放款比例：</dt>
                    <dd>
                        <input type="text" style="width: 400px;"  value="<?php echo ($crowd_detail['back_rate']); ?>" name="repayment_ratio" id="repayment_ratio"/>
    ...
    <script>
        ...
        function ajax_show(p)
        {
            ...
            if(isNaN(repayment_ratio)){
                ...
                $.get("__URL__/repayment_record?id=<?php echo ($crowd_detail['id']); ?>&repayment_ratio="+repayment_ratio+"&p="+p, function(data){
        ...
        function repayment(){
            ...
            if(isNaN(repayment_ratio)){
                ...
                status_1 = true;
                window.location.href="__URL__/go_repayment?id=<?php echo ($crowd_detail['id']); ?>&repayment_ratio="+repayment_ratio;
            }
        }
    </script>
</div>