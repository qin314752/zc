...
<div class="so_main">
 ...
 function addSettingResponse(res){
  ...
  <div class="form2">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = array_slice($list,0,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl class="lineD" id="line_<?php echo ($vo['id']); ?>">
