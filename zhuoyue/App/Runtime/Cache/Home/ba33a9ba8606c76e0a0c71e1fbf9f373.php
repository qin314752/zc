...
<meta http-equiv="description" content="<?php echo ($glo["web_descript"]); ?>"/>
        ...
        <link href="__ROOT__/Style/H/che/css/product.css" type="text/css" rel="stylesheet">
    <script src="__ROOT__/Style/H/che/js/public.js"></script>
    <script type="text/javascript" src="__ROOT__/Style/H/che/js/invest.js"></script>
    <script type="text/javascript" src="__ROOT__/Style/H/che/js/layer.js"></script>
    <link style="" id="__ROOT__/Style/H/che/css/layer.css" rel="stylesheet">
...
<div class="browsertip" id="browsertip" style="display: none;">
    ...
    <div class="contentbox" style="min-height:500px">
        <div class="wrapper prodwrap">
            <div class="path">
                <a href="https://www.weiclicai.com/">首页</a>&nbsp;/&nbsp;投资列表
            </div>
            <div class="plan">
                项目状态： 
					
					<?php foreach($searchMap['crowd_status'] as $key=>$v){ ?>
					<?php if($key==$searchUrl['crowd_status']['cur']){ ?>
					<a class="focus" href="/crowdinvest/index?type=search&&crowd_status=all"><?php echo ($v); ?></a>
					<?php }else{ ?>
					<a href="__URL__/index?type=search&<?php echo ($searchUrl["crowd_status"]["url"]); ?>&crowd_status=<?php echo ($key); ?>"><?php echo ($v); ?></a>
					<?php } ?>
					<?php } ?>
            </div>
            <div class="prodlist">
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="item">
                            <div class="c01">
                                <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>"><img style="height: 122px; margin-left: -20.3333px; visibility: visible;" src="<?php echo ($list['img'][0]['img']); ?>" onload="showimg($(this),122,122);" alt=""></a>

                            </div>
                            <div class="c02">
                                <div class="r01">
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>"><?php echo (cnsubstr($list["crowd_name"],20)); ?></a>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>">
									<i>
                                ...
                                <div class="r02">
                                    <div class="vam info">
                                        <div>
                                            <div class="cmain cc01">
                                                       <!-- <?php echo ($list["back_rate1"]); ?><span class="sub">%</span> ~ 894.25<span class="sub">%</span>-->
                                            </div>
                                            <div class="cc02"><?php echo ($list["crowd_money"]); ?><span class="sub">元</span></div>
                                            <div>1<span class="sub">天</span> ~ <?php echo ($list["max_duration"]); ?><span class="sub">天</span>
                                                                                            </div>
                                        </div>
                                        <div>
                                            <div>&nbsp;<i class="tips">
                                                    ...
                                                    <div class="tipsinfo" style="display: none;">
                                                        年化收益率=收益/本金/天数*365
                                                    </div>
                                                </i></div>
                                            <div>目标众筹价格&nbsp;</div>
                                            <div>最长持有期限&nbsp;<i class="tips">
                                                    <i class="up" style="display: none;"></i>
                                ...
                                <div class="r03">
                                    ...
                                    <i class="ico-back"></i><span class="sp2">车商担保回购，车辆物权反担保</span>
                                </div>
                            </div>
                            <div class="c03">
                                <!--<div class="r01">
                                ...
                                <div class="r02">
									<?php if($list["is_start"] == 0 ): ?><a href="/member/crowdauto#fragment-1" class="btngreen l-btn">我要预约</a>
                                    <?php elseif($list["status"] == 1 && $list["is_start"] == 1): ?>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>" class="btngreen l-btn" style="">我要认筹</a>
                                    <?php elseif($list["status"] == 2): ?>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>" class="btngreen l-btn" style="">出售中</a>
                                    <?php elseif($list["status"] == 3): ?>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>" class="btngreen l-btn" style="">投票中</a>
                                    <?php elseif($list["status"] == 4): ?>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>" class="btngreen l-btn" style="">待回款</a>
                                    <?php elseif($list["status"] == 5 ): ?>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>" class="btngreen l-btn" style="">已售出</a>
                                    <?php elseif( $list["status"] == 9): ?>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>" class="btngreen l-btn" style="">溢价回购</a>

                                    <?php else: ?>
                                    <a href="<?php echo (getcrowdinvesturl($list["id"])); ?>" class="btngreen l-btn" style="">溢价回购</a><?php endif; ?>
								</div>
                                <div class="r03">
                                    <div class="bars">
                                                                            </div>
                            ...
                            <span style="display: none;" id="my_param" data-id="0"></span><?php endforeach; endif; else: echo "" ;endif; ?>                     
                                                </div>
            <div class="pager">
                <ul class="pagination">
					<?php echo ($page); ?>
