...
<div class="width-100" style="_height:300px;height: auto;float: left;min-height: 300px;">
    <div class="width-100" style="height: 190px;">
        <div class="float_left martop_50 " style="padding-left: 40px;width: 160px;border-right: 1px solid #d7d7d7;height: 140px;">
            ...
            <div class="font14 martop_10" style="color: #333">平台总预约：<span style="color: #fc8936;font-size: 20px;"><?php echo (($all_count)?($all_count):0); ?></span>笔</div>
            <div class="font14" style="color: #333">当前预约中：<span style="color: #fc8936;font-size: 20px;"><?php echo (($now_count)?($now_count):0); ?></span>笔</div>
        </div>
        ...
        <div class="float_left martop_50" style="width: 160px;border-right: 1px solid #d7d7d7;height: 140px;padding-left: 45px;">
            ...
            <div class="font14 martop_10" style="color: #333"><span style="color: #fc8936;font-size: 20px;"><?php echo (($all_money)?($all_money):0); ?></span>元</div>
        </div>
        <div class="float_left martop_50" style="width: 145px;border-right: 1px solid #d7d7d7;height: 140px;padding-left: 45px;">
    ...
    <div class="width-90" style="_height:100px;height: auto;border: 1px solid #e5e5e5;min-height: 100px;margin: 30px auto 10px;">
        ...
        <table class="table invest_detail_color lineheight30 text-center invest_table" width="95%"  cellspacing="1" cellpadding="1" style="margin: 10px auto;">
            ...
            <?php if(is_array($auto_list)): $i = 0; $__LIST__ = $auto_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$al): $mod = ($i % 2 );++$i;?><tr>
                    <td class="tdContent1"><?php echo ($al["id"]); ?></td>
                    <td class="tdContent1"><?php echo ($al["auto_money"]); ?></td>
                    <td class="tdContent1"><?php echo ($al["employ_money"]); ?></td>
                    <td class="tdContent1"><span style="color: #fc8936;font-size: 14px;"><?php echo ($al["surplus_money"]); ?></span></td>
                    <td class="tdContent1"><?php echo (date("Y-m-d H:i:s",$al["deadline"])); ?></td>
                    <td class="tdContent1">第<span style="color: #fc8936;font-size: 14px;"><?php echo ($al["row_number"]); ?></span>名</td>
                    <td class="tdContent1"><span style="display: block;height: 26px;width: 60px;cursor: pointer;border-radius: 5px;background: #1BB8E2;margin: 0 auto;color: #fff" onclick="crowd_cancel(<?php echo ($al["id"]); ?>)">取消预约</span></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
            <tr>
                <td colspan="6">
                    <div data="fragment-1" id="pager" style="float: right; text-align: right; width: 500px; padding-right: 0px;" class="yahoo2 ajaxpagebar"><?php echo ($pagebar); ?></div>
                </td>
            </tr>
        </table>
    </div>
