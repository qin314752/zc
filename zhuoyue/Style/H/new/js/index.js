...
function showTa(type,obj){
			...
			function showDeal(type,obj){
				$("#deal_show_nav a").removeClass("deal_sh_in");
				$(obj).addClass("deal_sh_in");
				if(type=="deal_info_show"){
					$("#deal_info_show").show();
					$("#deal_show_dt").hide();
					$("#deal_show_pl").hide();
					$("#peoplenum").hide()
					$("#deal_show_ht").hide();
				}else if(type=="deal_show_dt"){
					$("#deal_info_show").hide();
					$("#deal_show_dt").show();
					$("#deal_show_pl").hide();
					$("#peoplenum").hide()
					$("#deal_show_ht").hide();
				}else if(type=="deal_show_pl") {
					$("#deal_info_show").hide();
					$("#deal_show_dt").hide();
					$("#deal_show_pl").show();
					$("#peoplenum").hide()
