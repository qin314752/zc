			...
			<div class="tabBar cl" >
			 ...
			 <div class="tabCon" >
				<div class="row cl" style="border-bottom: 1px dashed #E2E2E2;padding-top:2px;padding-bottom:5px;">
					...
					<span class="formControls col-xs-3 col-sm-3" ><input style="height: 25px" type="text" value="" class="input-text"></span>
				...
				<div class="row cl" style="border-bottom: 1px dashed #E2E2E2;margin-top:-1px;padding-top:2px;padding-bottom:5px;">
					...
					<select class="select" name="user_role" size="1">
		 					...
		 					<option value="">9天</option>
		 					<option value="">10天</option>
						</select>
					</span>
				...
				<div class="row cl" style="border-bottom: 1px dashed #E2E2E2;margin-top:-1px;padding-top:2px;padding-bottom:5px;">
					...
					<span class="formControls col-xs-3 col-sm-3" >
					<script id="editor" type="text/plain" style="width:800px;height:250px;"></script></span>
					<span class="c-orange">*ssssssssss</span>
				</div>
				<div class="row cl" style="border-bottom: 1px dashed #E2E2E2;margin-top:-1px;padding-top:2px;padding-bottom:5px;">
					<label class="form-label col-xs-3 col-sm-2">项目简介:</label>
					<span class="formControls col-xs-3 col-sm-3" >
						<script id="editor1" type="text/plain" style="width:800px;height:250px;"></script></span>
					</span>
				</div>
				<div class="row cl" style="border-bottom: 1px dashed #E2E2E2;margin-top:-1px;padding-top:2px;padding-bottom:5px;">
						   ...
						   <div class="demo">
				             ...
				             <script type="text/javascript">
					            ...
					            window.onload = function() {
					                swfu = new SWFUpload({
					                    upload_url: "<?php echo U('Admin/System/upload');?>",
