...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form action="/index.php/Admin/NoticeTemplate/data" method="post" class="form form-horizontal" id="form-article-add">
					...
					<div class="tabCon">
						<div class="row cl dashed">
							...
							<div class="formControls col-xs-8 col-sm-3">
								<textarea name="" class="textarea_color" ></textarea> 
							</div>
						...
						<div class="row cl dashed">
							...
							<div class="formControls col-xs-8 col-sm-3">
								<textarea name="" value="" class="textarea_color" ></textarea> 
							</div>
