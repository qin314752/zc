...
<div class="loginWraper" style="margin: 10% 0% 0% 20% ">
	<div id="loginform" class="loginBox">
		<form class="form form-horizontal" action="{:U('Admin/Login/login')}" method="post">
			<div class="row cl">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					<input class="input-text size-L" type="text" style="width:150px;" name="verify_code">
					<img id="img" src="{:U('Admin/Login/verify_code')}"  >
					<a in="imgs" href="javascript:;" >看不清，换一张</a>
				</div>
			</div>
