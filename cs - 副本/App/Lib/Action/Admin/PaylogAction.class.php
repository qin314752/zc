...
class PaylogAction extends ACommonAction
{
    ...
    */
	...
	public function _listFilter($list){
	 	$listType = C('PAYLOG_TYPE');
	 	$payType = array('off'=>'线下充值','gfb'=>'国付宝','ips'=>'环迅支付','chinabank'=>'网银在线','baofoo'=>'宝付','shengpay'=>'盛付通','tenpay'=>'财付通','ecpss'=>'汇潮支付','easypay'=>'易生支付','cmpay'=>'中国移动支付','allinpay'=>'通联支付','allinpaywap'=>'通联wap支付');
    ...
    */
    public function paylogonline()
    {
		...
		$this->assign('type_list',$listType);
		$field= 'id,uid,status,money,add_time,tran_id,way,off_bank,off_way,deal_user';
		$map['way']=array("in",'gfb,ips,chinabank,baofoo,shengpay,tenpay,ecpss,easypay,cmpay,allinpay,allinpaywap,baofuwap');
		$this->_list(D('Paylog'),$field,$map,'id','DESC',$xtime);
        $this->display();
    }
