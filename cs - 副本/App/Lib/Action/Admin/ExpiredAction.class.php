...
//		if(session('admin_is_kf')==1)	$map['m.customer_id'] = session('admin_id');
		...
		$field = "m.user_name,d.borrow_id as id,b.borrow_name,d.status,d.total,d.borrow_id,b.borrow_uid,d.sort_order,sum(d.capital) as capital,sum(d.interest) as interest,sum(d.substitute_money) as substitute_money,d.deadline,b.borrow_duration,b.repayment_type";
