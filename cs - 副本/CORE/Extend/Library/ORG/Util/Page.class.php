...
class Page {
    ...
    public function ajax_show()
    {
        ...
        $downRow = $this->nowPage+1;
        if ($upRow>0){
//            $upPage="<a href='javascript:void(0);' onclick=\"ajax_show($upRow{$idtagert})\" style=\"display:none\">".$this->config['prev']."</a>";
        }else{
            $upPage="";
        }
...
//            $downPage="<a javascript:void(0);' onclick=\"ajax_show($downRow{$idtagert})\"  style=\"display:none\">".$this->config['next']."</a>";
		...
		for($i=1;$i<=$this->totalPages;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "&nbsp;<a  href='javascript:void(0);' onclick=\"ajax_show($page)\" class=\"current\">&nbsp;".$page."&nbsp;</a>";
                }
            }
        }
