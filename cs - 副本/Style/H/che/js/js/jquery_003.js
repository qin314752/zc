(function(a) {
    ...
    a.jBox.prompt = function(b, c, d, e) {
        ...
        h.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute; top:' + (f + e.border+40) + 'px;left:' + (0xa + e.border) + 'px; width:35px; height:36px;"></span>');
        h.push(e.content);
        h.push('</div>');
        e.content = h.join('');
        a.jBox(e.content, e)
    ...
    a.jBox.messager = function(b, c, d, e) {
        ...
        i.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute; top:' + (g + e.border+40) + 'px;left:' + (0xa + e.border) + 'px; width:35px; height:36px;"></span>');
        i.push(e.content);
        i.push('</div>');
        e.content = i.join('');
        a.jBox(e.content, e)
